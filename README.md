<h1 align="center"> 🚀 Crono | Vanilla </h1>

## ✍️ Descrição
Exemplificação de aplicação de  cronômetro usando vanilla ou Javascript puro
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/crono-vanilla.git
    ```
1. Download:
    ### Download Manual
...
[Publicação em Codepen](https://codepen.io/cleibp/pen/OJwZgdm) 
